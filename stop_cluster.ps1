...
Write-Host "[1] Arrêt de Mongos..." -ForegroundColor Yellow
Get-Process mongos -ErrorAction SilentlyContinue | Stop-Process -Force
Start-Sleep -Seconds 2
Write-Host "✅ Mongos arrêté`n" -ForegroundColor Green

Write-Host "[2] Arrêt de tous les Mongod..." -ForegroundColor Yellow
Get-Process mongod -ErrorAction SilentlyContinue | Stop-Process -Force
Start-Sleep -Seconds 3
Write-Host "✅ Tous les mongod arrêtés`n" -ForegroundColor Green

Write-Host "[3] Vérification des processus..." -ForegroundColor Yellow
$remaining = Get-Process mongod, mongos -ErrorAction SilentlyContinue
if ($remaining) {
    Write-Host "⚠️  Processus restants:" -ForegroundColor Yellow
...
Write-Host "✅ CLUSTER ARRÊTÉ" -ForegroundColor Green
Write-Host "========================================`n" -ForegroundColor Green

Write-Host "📁 Données préservées dans:" -ForegroundColor Cyan
...
Write-Host "  .\restart_cluster.ps1`n" -ForegroundColor Yellow